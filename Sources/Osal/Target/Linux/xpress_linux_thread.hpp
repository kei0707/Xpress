...
public:
   ...
   * @return
   */
  error_enum_t stack_size(const uint64_t a_stack_size) { return success; }
   ...
   * @return
   */
  error_enum_t create(void) { return success; }
   ...
   * @return
   */
  error_enum_t run(void) { return success; }
   ...
   * @return
   */
  error_enum_t join(void) { return success; }
   ...
   * @return
   */
  error_enum_t stop(void) { return success; }
   ...
   * @return
   */
  error_enum_t destroy(void) { return success; }
